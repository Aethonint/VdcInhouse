  <header class="top-header">        
        <nav class="navbar navbar-expand">
          <div class="mobile-toggle-icon d-xl-none">
            ...
            <h4 class="top-header-heading me-auto">Welcome Back.</h4>
            </div>
            ...
            <div class="top-navbar-right ms-3">
              ...
              <li class="nav-item dropdown dropdown-large">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="">
                ...
                <div class="dropdown-menu dropdown-menu-end p-0">
                 ...
                 <div class="header-message-list p-2">
                    <div class="dropdown-item bg-light radius-10 mb-1">
                     ...
                     <a class="dropdown-item" href="#">
                       <div class="d-flex align-items-center">
                          <img src="{{asset('adminui/assets/images/avatars/avatar-1.png')}}" alt="" class="rounded-circle" width="52" height="52">
                          <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('adminui/assets/images/avatars/avatar-2.png')}}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('adminui/assets/images/avatars/avatar-3.png')}}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('adminui/assets/images/avatars/avatar-4.png')}}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('adminui/assets/images/avatars/avatar-5.png')}}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('adminui/assets/images/avatars/avatar-6.png')}}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
