          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="{{route('vehicle.index')}}"><i class="bi bi-arrow-right-short"></i>Vehicle List</a>
                 ...
                 <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Vehicle Documents</a>
                </li>
                 <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Wash Tracker </a>
                </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li> <a href="{{route('assign_vehicle.index')}}"><i class="bi bi-arrow-right-short"></i>Assign Vehicle</a>
                 ...
                 <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Driver Documents</a>
                </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Resolved Defects</a>
                </li>
            ...
            <!-- <li class="sidebar-divider"></li> -->
             ...
             <li>
              ...
              <ul>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Site List</a>
                </li>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Site Reports</a>
                </li>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Site Inspections</a>
                </li>
              </ul>
            </li>
             <li>
             ...
             <li>
              ...
              <ul>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Generate PDF/Excel</a>
                </li>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Monthly Summary</a>
                </li>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Export Logs</a>
                </li>
              </ul>
            </li>
             ...
             <li>
              ...
              <ul>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Users & Roles</a>
                </li>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Notifications</a>
                </li>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Company Info</a>
                </li>
              </ul>
            </li>
             <li>
              ...
              <ul>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Line Icons</a>
                </li>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Boxicons</a>
                </li>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Feather Icons</a>
                </li>
              </ul>
            </li>
